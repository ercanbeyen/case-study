...
public class MovieController {
    ...
    @PostMapping
    public ResponseEntity<Object> createMovie(@RequestBody MovieDto movie) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateMovie(@PathVariable String id, @RequestBody MovieDto movie) {
